# Learvix Project Overview

## Project Summary

Learvix is a collaborative learning platform featuring **SkillProof AI** for skill verification. The motto: **"Don't show your certificate. Show what you can actually do."** Users can register, build a profile, discover learning partners, track exchange progress, and view notifications. The new SkillProof system enables AI-powered skill assessment and certification.
