    ...
    <div style={styles.container}>
      ...
      <div style={styles.loginCard} className="glass-card-static anim-scaleIn">
        ...
        <div style={styles.header}>
          ...
          <h1 style={styles.title}>Learvix</h1>
          <p style={styles.subtitle}>
            {isRegister ? "Start your collaborative learning journey" : "Welcome back. Log in to continue."}
          </p>
        </div>
        ...
        <div style={styles.footer}>
          <p style={styles.toggleText}>
            {isRegister ? "Already have an account?" : "New to Learvix?"}{" "}
            <span
