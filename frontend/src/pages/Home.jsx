    ...
    <div className="page-container" style={styles.container}>
      ...
      <section style={styles.heroSection} className="anim-fadeInUp">
        ...
        <p style={styles.heroSubtitle}>
          Trade your expertise for the skills you want. Join Learvix to connect, match, and grow together through collaborative video sessions.
        </p>
      ...
      <section style={styles.section} className="anim-fadeInUp delay-2">
        <div className="section-header">
          <div>
            <h2 className="section-title">How Learvix Works</h2>
